...
const ResultsDropdown = ({ teamChannels, directChannels, focusedId, loading, setChannel, setToggleContainer }) => {
  ...
  return (
    <div className='channel-search__results'>
      ...
      {!loading && !directChannels.length ? ( //(conditional rendering) --Ensures that loading is false and directChannels is empty(0) or it will maps over directChannels to render "SearchResult" components.
        <p className='channel-search__results-header'>
